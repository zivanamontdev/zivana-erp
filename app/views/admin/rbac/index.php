...
<p class="text-caption-md">Izin Edit memerlukan Lihat. Guru hanya dapat mengakses Portal Guru dan persetujuan eRapor bila ditugaskan secara eksplisit; halaman penugasan penyetuju hanya tersedia bagi role non-guru. Hak role dan penugasan approver sama-sama diperlukan. Login ulang setelah perubahan izin.</p>
<div class="rbac-list">
    ...
    <div class="rbac-role">
        ...
        <form method="POST" action="<?= BASE_PATH ?>/rbac" class="rbac-role-body" data-rbac-form>
            ...
            <?php if ($role['nama'] === 'Guru' && $modul !== 'Portal Guru' && !($modul === 'eRapor' && isset($sections['Persetujuan']))) continue; ?>
            <div class="rbac-modul" data-tree-group>
                ...
                <div class="rbac-modul-body">
                    <?php foreach ($sections as $sectionName => $subSections): ?>
                        <?php if ($role['nama'] === 'Guru' && $modul === 'eRapor' && $sectionName !== 'Persetujuan') continue; ?>
