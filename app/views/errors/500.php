...
<head>
    ...
    <style>
        body { font-family: var(--font-family-base); display: flex; align-items: center; justify-content: center; min-height: 100vh; margin: 0; background: var(--color-neutral-50); }
        .box { text-align: center; max-width: 640px; padding: 0 var(--space-4); }
