...
CREATE TABLE template_rapor(id INTEGER,tipe TEXT DEFAULT 'system');
...
INSERT INTO template_rapor(id) VALUES(1);
...
INSERT INTO template_rapor(id) VALUES(2);");
$result = EraporLegacyAudit::inspect($db);
...
auditCheck((int)$result['unassigned_breakdown'][0]['with_grades'] === 1, 'Historical grades retained');
auditCheck((int)$result['empty_template_usage'][0]['reports'] === 0, 'Empty template usage');
